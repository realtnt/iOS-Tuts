...
var classLibraryBooks = students.map { $0.libraryBooks }
...
var classPets = students.compactMap { $0.pet }
...
var flatLibraryBooks = classLibraryBooks.flatMap { $0 }

print( flatLibraryBooks )
